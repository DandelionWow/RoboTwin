...
class ep2_1_object_pose_adjust_bottle(Base_Task):

    # 调用父类 Base_Task 的 _init_task_env_()，初始化仿真环境、机械臂、相机、场景参数等
    ...
    def load_actors(self):
        ...
        # self.bottle.get_pose().to_transformation_matrix() 获取这个actor的位姿矩阵
    ...
    def play_once(self):
        ...
        self.move(self.grasp_actor(self.bottle, arm_tag=arm_tag, pre_grasp_dis=0.1)) # 找物体的功能点
